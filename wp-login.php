...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://www.aurora.asn.au'); ?>" title="<?php echo apply_filters('login_headertitle', esc_attr__('Powered by WordPress')); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
...
case 'register' :
	...
	login_header(__('Registration Form'), '<p class="message register">' . __('Register For This Site / Newsletter Sign Up') . '</p>', $errors);
?>
...
<?php		exit;
	...
	elseif	( isset($_GET['checkemail']) && 'registered' == $_GET['checkemail'] )
		$errors->add('registered', __('Registration complete. Please check your e-mail. If the email doesn\'t appear in your inbox, please check your junk mail box.'), 'message');
