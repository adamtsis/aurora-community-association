var supersleight=function(){var root=false;
    ...
    var shim='wp-content/themes/aca2011/images/x.gif';
...
func();};}};return{init:function(){addLoadEvent(fnLoadPngs);},limitTo:function(el){root=el;},run:function(){fnLoadPngs();}};}();var ua=window.navigator.userAgent;var msie=ua.indexOf("MSIE ");if(msie>0){var ieversion=parseInt (ua.substring (msie+5, ua.indexOf (".", msie )));if(ieversion<=7){supersleight.init();}}
